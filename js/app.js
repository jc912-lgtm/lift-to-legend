...
function App(){
  ...
  useEffect(()=>{
    const bgmMap={title:'title',create:'title',hub:'title',training:'training',comp:'competition',status:'shop',shop:'shop',jobs:'shop',achievements:'shop',pool:'shop',restaurant:'shop',friend:'shop',home:'shop',cafe:'shop',laundry:'shop',river:'shop',nstc:'training',wangfund:'shop',tianliao:'training',mituo:'shop'};
